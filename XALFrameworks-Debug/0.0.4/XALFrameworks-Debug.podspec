...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/zhangfenglin/XALFrameworks'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangfenglin' => 'zhangfenglin@apusapps.com' }
  s.source           = { :git => 'https://github.com/zhangfenglin/XALFrameworks.git', :tag => s.version.to_s }

  s.ios.deployment_target = '9.3'
  
  s.subspec "APSLibraryAdapter" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSLibraryAdapter.framework"
  ...
  s.subspec "APSActivate" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSActivate.framework"
  ...
  s.subspec "APSCloud" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSCloud.framework"
      ss.dependency 'XALFrameworks-Debug/APSZeus'
      ss.dependency 'XALFrameworks-Debug/APSMiddleware'
      ss.dependency 'XALFrameworks-Debug/APSSdkService'
      ss.dependency 'XALFrameworks-Debug/APSUtilities'
  ...
  s.subspec "APSAlex" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSAlex.framework"
      ss.dependency 'XALFrameworks-Debug/APSUtilities'
      ss.dependency 'XALFrameworks-Debug/APSZeus'
      ss.dependency 'XALFrameworks-Debug/APSMiddleware'
      ss.dependency 'XALFrameworks-Debug/APSSdkService'
  ...
  s.subspec "APSSupport3rd" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSSupport3rd.framework"
  ...
  s.subspec "APSMiddleware" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSMiddleware.framework"
  end
  
  s.subspec "APSSdkService" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSSdkService.framework"
  end
  
  s.subspec "APSZeus" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSZeus.framework"
  ...
  s.subspec "APSAdjust" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSAdjust.framework"
      
      ss.dependency 'Adjust', '4.18.0'
  end
  
  s.subspec "APSLogServer" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSLogServer.framework"
      
      ss.dependency 'GCDWebServer', '3.5.3'
  end
  
  s.subspec "APSUtilities" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSUtilities.framework"
  ...
  s.subspec "APSRouter" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSRouter.framework"
  end
  
  s.subspec "APSFcmPush" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/APSFcmPush.framework"
  ...
  s.subspec "du" do |ss|
      ss.ios.vendored_frameworks = "XALFrameworks-Debug/Frameworks/du.framework"
  end
